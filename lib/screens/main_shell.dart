...
import 'home/launcher_home_screen.dart';
import 'home/home_screen.dart' show VersionsScreen, AccountScreen, SettingsScreen;
...
class _MainShellState extends State<MainShell> {
  int _index = 0;
  static final _screens = <Widget>[const LauncherHomeScreen(), const VersionsScreen(), const AccountScreen(), const SettingsScreen()];
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        child: BottomNavigationBar(
          ...
          type: BottomNavigationBarType.fixed, selectedFontSize: 11, unselectedFontSize: 11,
